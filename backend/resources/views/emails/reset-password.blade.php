                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 8px;">
                                        <a href="{{ config('app.url') }}/reset-password?email={{ $user->email }}&token={{ $token }}" style="display: inline-block; padding: 13px 40px; background: linear-gradient(135deg, #00843D, #02421D); color: #ffffff; text-decoration: none; border-radius: 12px; font-size: 14px; font-weight: 600; box-shadow: 0 4px 16px rgba(0,132,61,0.25);">Réinitialiser le mot de passe</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
