                    ...
                    <tr>
                        <td style="padding:36px 40px 24px;">
                            <p style="font-size:15px;color:#1a1a1a;margin:0 0 16px;">
                                Bonjour <strong style="color:#00843D;"><?php echo e($offre->intern->user->prenom); ?> <?php echo e($offre->intern->user->nom); ?></strong>,
                            </p>
                            ...
                            <p style="font-size:14px;color:#555;margin:0 0 8px;line-height:1.7;">
                                <strong>Référence :</strong> <?php echo e($offre->reference); ?>

                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding:16px 0 8px;">
                                        <a href="<?php echo e(config('app.url')); ?>/intern/application" style="display:inline-block;padding:13px 40px;background:linear-gradient(135deg,#00843D,#02421D);color:#ffffff;text-decoration:none;border-radius:12px;font-size:14px;font-weight:600;box-shadow:0 4px 16px rgba(0,132,61,0.25);">
                                            Voir mon espace
                                        </a>
                                    </td>
                                </tr>
...
<?php /**PATH /var/www/html/resources/views/emails/offre-stage.blade.php ENDPATH**/ ?>