                ...
                <table width="560" cellpadding="0" cellspacing="0" style="max-width: 560px; background: #ffffff; border-radius: 20px; box-shadow: 0 8px 32px rgba(0,132,61,0.08); overflow: hidden;">
                    <tr>
                        <td style="background: linear-gradient(135deg, #00843D, #02421D); padding: 28px 40px 24px; text-align: center;">
                            <h1 style="color: #ffffff; font-size: 22px; margin: 0; font-weight: 600; letter-spacing: -0.3px;">Réinitialisation de mot de passe</h1>
                    ...
                    <tr>
                        <td style="padding: 36px 40px 24px;">
                            <p style="font-size: 15px; color: #1a1a1a; margin: 0 0 16px;">
                                Bonjour <strong style="color: #00843D;"><?php echo e($user->prenom); ?> <?php echo e($user->nom); ?></strong>,
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 8px;">
                                        <a href="<?php echo e(config('app.url')); ?>/reset-password?email=<?php echo e($user->email); ?>&token=<?php echo e($token); ?>" style="display: inline-block; padding: 13px 40px; background: linear-gradient(135deg, #00843D, #02421D); color: #ffffff; text-decoration: none; border-radius: 12px; font-size: 14px; font-weight: 600; box-shadow: 0 4px 16px rgba(0,132,61,0.25);">Réinitialiser le mot de passe</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 40px 32px; text-align: center;">
                            <p style="font-size: 11px; color: #aaa; margin: 0; line-height: 1.6;">
                                ...
                                &copy; <?php echo e(date('Y')); ?> Gestion des Stages OCP. Tous droits réservés.
                            </p>
                        </td>
                    </tr>
                </table>
...
<?php /**PATH /var/www/html/resources/views/emails/reset-password.blade.php ENDPATH**/ ?>