const colors = {
  slate: 'bg-ocp-50 text-ocp-700 border-ocp-200',
...
const Badge = ({ color = 'slate', children, className = '' }) => (
  <span className={`inline-flex items-center px-2 py-0.5 text-xs font-medium border rounded-lg ${colors[color]} ${className}`}>
    {children}
  </span>
);
