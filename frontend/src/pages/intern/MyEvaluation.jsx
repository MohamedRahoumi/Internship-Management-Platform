      ...
      <div className="bg-white border border-ocp-100 rounded-xl p-6 space-y-5">
          ...
          return (
            <div key={key}>
              <div className="flex justify-between items-center mb-1.5">
                <span className="text-sm font-medium text-ocp-700">{criteriaLabels[key]}</span>
                <span className="text-sm font-bold text-ocp-800">{value}/100</span>
              </div>
        ...
        {evaluation.comment && (
          <div className="pt-4 border-t border-ocp-100">
            <h3 className="text-xs font-semibold text-ocp-500 uppercase tracking-wider mb-2">Commentaire</h3>
            <p className="text-sm text-ocp-700 bg-ocp-50 rounded-xl p-3 border border-ocp-100">{evaluation.comment}</p>
          </div>
        )}
